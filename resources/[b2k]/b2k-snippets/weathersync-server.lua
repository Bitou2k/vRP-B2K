...
local SmartWeatherEnabled = false -- Should this script be enabled?
...
weatherTree = {
	...
	["XMAS"] = {"SNOWLIGHT", "SNOW", "XMAS"},
}

-- TriggerClientEvent("smartweather:updateWeather", -1, { ["weatherString"] = "CLEAR", ["windEnabled"] = true, ["windHeading"] = 250 })
...
TriggerClientEvent("smartweather:updateWeather", -1, { ["weatherString"] = "CLEAR", ["windEnabled"] = false, ["windHeading"] = 0 })
