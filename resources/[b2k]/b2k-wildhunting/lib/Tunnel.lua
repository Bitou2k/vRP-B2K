...
local function tunnel_resolve(itable,key)
  ...
  local fcall = function(args,callback)
    ...
    if type(callback) == "function" then -- ref callback if exists (become a request)
      ...
      TriggerServerEvent(iname..":tunnel_req:b2k",key,args,identifier,rid)
    else -- regular trigger
      TriggerServerEvent(iname..":tunnel_req:b2k",key,args,"",-1)
    end
...
function Tunnel.bindInterface(name,interface)
  -- receive request
  RegisterNetEvent(name..":tunnel_req:b2k")
  AddEventHandler(name..":tunnel_req:b2k",function(member,args,identifier,rid)
    ...
    if type(f) == "function" then
      ...
      TUNNEL_DELAYED = function()
        ...
        return function(rets)
          rets = rets or {}
          if rid >= 0 then
            TriggerServerEvent(name..":"..identifier..":tunnel_res:b2k",rid,rets)
          end
        end
      end
...
function Tunnel.getInterface(name,identifier)
  ...
  -- receive response
  RegisterNetEvent(name..":"..identifier..":tunnel_res:b2k")
  AddEventHandler(name..":"..identifier..":tunnel_res:b2k",function(rid,args)
