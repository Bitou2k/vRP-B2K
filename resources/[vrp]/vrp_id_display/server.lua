...
AddEventHandler("vRP:playerLeave",function(user_id, source) 
	--TriggerClientEvent("vrp:id:rem", -1, user_id)
	local users = vRP.getUsers({})
	for k,v in pairs(users) do
		TriggerClientEvent("vrp:id:rem", v, user_id)
...
AddEventHandler("vRP:playerSpawn", function(user_id, source, first_spawn) 
	...
	--[[for k,v in pairs(users) do
	  ...
	  TriggerClientEvent("vrp:id:add", source, k, v)
	  TriggerClientEvent("vrp:id:add", v, user_id, source)
...
function vRPidd.getUserID(source)
end