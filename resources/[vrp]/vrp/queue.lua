...
Config.Language = {
    ...
    err = "[B2K] Erro: Não foi possível receber seus ID's de conexão, tente reconectar.",
    _err = "[B2K] Aconteceu um Erro.",
    pos = "[B2K] Você é %d/%d na Fila.",
    connectingerr = "[B2K] Aconteceu um erro ao adicionar você na lista de conexões.",
    banned = "You are banned, you may appeal it at www.whatever.net | Reason: %s",
    steam = "[B2K] Erro: Obrigatório uso da Steam.",
...
Citizen.CreateThread(function()
    local function playerConnect(name, setKickReason, deferrals)
        ...
        if not steamNotWhitelisted then
            done("[B2K] Sua Steam não está autorizada: " .. steamIDUser)
            deferrals.done("[B2K] Sua Steam não está autorizada: " .. steamIDUser)
