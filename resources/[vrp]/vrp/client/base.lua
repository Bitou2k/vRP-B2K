...
function tvRP.newNotify(entry, color, elements, sound)
		if (color ~= -1) then
...
function tvRP.notify(msg)
	tvRP.newNotify("STRING", 11, {"" .. msg}, true)
  --SetNotificationTextEntry("STRING")
  --AddTextComponentString(msg)
  --DrawNotification(true, false)
  --TriggerEvent("pNotify:SendNotification", { text = msg, type = "success", timeout = 2000, layout = "centerRight", queue = "right" })
end
