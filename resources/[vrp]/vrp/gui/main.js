window.addEventListener("load",function(){
 ...
 $.post("http://vrp/cfg",""); 
  ...
  window.addEventListener("message",function(evt){ //lua actions
    ...
    if(data.act == "vendaOlhosUsar"){
      $("#vendaolhos").fadeIn("slow");
    }
    else if(data.act == "vendaOlhosRetirar"){
      $("#vendaolhos").fadeOut("slow");
    }
    else if(data.act == "vendaOlhosTempo"){
      $("#vendaolhos").html("Tempo Vendado Restante: " + data.tempo + " segundos");
    }	
