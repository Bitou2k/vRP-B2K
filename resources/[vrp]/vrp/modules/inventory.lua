              ...
              if vRP.tryGetInventoryItem(user_id,idname,amount,true) then
                ...
                vRPclient.playAnim(nplayer,{true,{{"mp_common","givetake2_a",1}},false})
        				...
        				if string.match(idname, "wbody") or string.match(idname, "wammo") then
        					vRP.logToFile("giveLog.txt","De: "..user_id.." - Para: "..nuser_id.." - Item: " ..idname.." - Amount: " .. amount)
        				end
        				
        				if string.match(idname, "money") then
        					vRP.logToFile("giveMoneyLog.txt","De: "..user_id.." - Para: "..nuser_id.." - Item: " ..idname.." - Amount: " .. amount)
        				end
...
function vRP.getInventoryMaxWeight(user_id)
  return math.floor(vRP.expToLevel(vRP.getExp(user_id, "personagem", "strength")))*cfg.inventory_weight_per_strength
end
                ...
                if new_weight <= vRP.getInventoryMaxWeight(user_id) then
                  ...
                  if citem.amount <= 0 then
                    chest.items[idname] = nil -- remove item entry
        				  ...
        				  if string.match(idname, "wbody") or string.match(idname, "wammo") then
        					vRP.logToFile("chestVehLog.txt","Retirado Por: "..user_id.." - ChestName: "..name.." - Item: " .. idname.." - Amount: " .. amount)
        				  end
        				  
        				  if string.match(idname, "money") then
        					vRP.logToFile("chestVehMoneyLog.txt","Retirado Por: "..user_id.." - ChestName: "..name.." - Item: " .. idname.." - Amount: " .. amount)
        				  end
                ...
                if amount > 0 and vRP.tryGetInventoryItem(user_id, idname, amount, true) then
                  ...
                  if citem ~= nil then
                    ...
                    chest.items[idname] = {amount=amount}
        				  ...
        				  if string.match(idname, "money") then
        					vRP.logToFile("chestVehMoneyLog.txt","Colocado Por: "..user_id.." - ChestName: "..name.." - Item: " ..idname.." - Amount: " ..amount)
        				  end
