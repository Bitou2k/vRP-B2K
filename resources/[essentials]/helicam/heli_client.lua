...
local toggle_rappel = 7 -- control id to rappel out of the heli. Default: INPUT_DUCK (X) L
...
function IsPlayerInPolmav()
    ...
    --if( IsPolmav or IsAS350 or IsMaverick or IsBuzzard or IsBuzzard2 or IsValkyrie or IsFrogger or IsFrogger2) then
	if(IsAS350) then
        isCorrect = true
    end
	return isCorrect
